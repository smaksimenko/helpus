...
window.store = {
    ...
    populate: function () {
        ...
        this.financeBank[1] = {
            ...
            target: "пополнение карточки №4149437744067222б Салтановский Максим Владимирович",
            cardNumber: 4149437744067222,
            currency: window.CURRENCY.UAH,
            comment: "Возможен перевод прямо на карту в приемныйх аппаратах Привет банка"
        };
        this.financeBank[2] = {
            id: 2,
            forCountry: "Украина",
