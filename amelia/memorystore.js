...
window.store = {
    ...
    populate: function () {
        ...
        this.persona[2] = {
            ...
            message: "<p> 7 мая 2014 года наша Амелька утром стала ангелочком...Состояние было тяжелое, стабилизировать крошку так и не удалось....Пожалуйста, помолитесь все...Мягких тебе облачков, малышка...</p><h2 style='text-align: center'>***</h2>" +
                "<p>Во вторник состоялась беседа с врачами,в результате которой нам было отказано в проведении трансплантации Амельке...             Аргументом этому было сказано то, что врачи боятся делать операцию, так как риски очень большие и причиной этому проблема со спиной. " +
